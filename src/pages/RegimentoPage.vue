...
export default defineComponent({
  created() {
    axios
      .post("http://18.229.118.205:8686:8686/admin/titulo/list")
      .then((res) => {
    ...
    axios
      .post("http://18.229.118.205:8686:8686/admin/artigo/list")
      .then((res) => {
        console.log(res)
    ...
    axios
      .post("http://18.229.118.205:8686:8686/admin/capitulo/list")
      .then((res) => {
    ...
    axios.post("http://18.229.118.205:8686:8686/admin/secao/list").then(res => {
    ...
    axios.post("http://18.229.118.205:8686:8686/admin/subsecao/list").then(res => {

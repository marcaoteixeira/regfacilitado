  ...
  <div class="container is-fluid">
    ...
    <div class="columns i-centered ">
      <div class="column is-four-fifths">
        <div class="card">
          <h1 class="Cadastro Seção">Cadastro Artigo</h1><br>
          ...
          <div class="field is-horizontal">
            ...
            <div class="field-body">
              <div class="field">
                <p class="control">
                  <input class="input is-info" v-model="artigo" type="text" name="artigo" placeholder="Artigo" />
                </p>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    clearpage(){
      this.$router.go('/admin/artigonew')
    },    
    cadastro() {
      //this.$swal('Cadastro com Sucesso!');
      axios.post("http://localhost:8686/admin/artigo/new", {
        ...
        this.$swal('Cadastro com Sucesso!'), 
        //this.$router.go('/admin/subsecaonew')
